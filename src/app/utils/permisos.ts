...
export const PLANTILLAS: Record<RolNombre, ReadonlyArray<string>> = {
	...
	ADMINISTRATIVO: [
		...
		// Almacén / compras administrativas
		'ALMACEN.STOCK.VER',
		'ALMACEN.STOCK.GESTIONAR',
		'ALMACEN.STOCK.EXPORTAR',
		'ALMACEN.ARTICULOS.VER',
		'ALMACEN.ARTICULOS.CREAR',
		'ALMACEN.ARTICULOS.EDITAR',
		'ALMACEN.PROVEEDORES.VER',
		'ALMACEN.PROVEEDORES.CREAR',
		'ALMACEN.PROVEEDORES.EDITAR',
		'ALMACEN.SOLICITUDES.VER',
		'ALMACEN.SOLICITUDES.CREAR',
		'ALMACEN.SOLICITUDES.EDITAR',
		'ALMACEN.SOLICITUDES.GESTIONAR',
		'ALMACEN.SOLICITUDES.IMPRIMIR',
		'ALMACEN.ORDENES.VER',
		'ALMACEN.ORDENES.CREAR',
		'ALMACEN.ORDENES.IMPRIMIR',
		'ALMACEN.ACTAS.VER',
		'ALMACEN.ACTAS.CREAR',
		'ALMACEN.ACTAS.IMPRIMIR',
		'ALMACEN.MOVIMIENTOS.VER',
		'ALMACEN.MOVIMIENTOS.EXPORTAR',
		'ALMACEN.CONFIG.VER',
		'ALMACEN.CONFIG.EDITAR',
