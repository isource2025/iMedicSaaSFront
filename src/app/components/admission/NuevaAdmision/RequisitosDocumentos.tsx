  ...
  return (
    <div className={styles.bloque}>
      ...
      <p className={styles.ayuda}>
        Se cargan solos según la cobertura elegida (imClientesRequisitos). Podés agregar cualquier
        otro y subir una imagen o PDF por cada uno (DNI, hoja de derivación, recibo de sueldo,
